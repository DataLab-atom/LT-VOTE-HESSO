...
class OTO:
    ...
    def hesso(self, lr=0.1, weight_decay=None, first_momentum=None, second_momentum=None, \
               variant='sgd', target_group_sparsity=0.5, start_pruning_step=50, \
               pruning_steps=1, pruning_periods=1, device='cuda',\
               dampening=None, group_divisible=1, fixed_zero_groups=True, importance_score_criteria='default',args=None):
